...
<head>
    ...
    <title>${requestScope.admin.blog_title} - home</title>
</head>
<body>
<div id="Top">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-12 p-3 bg-white">
                    <h2>${requestScope.admin.blog_title}</h2>
                        ...
                        <div>
                            ...
                            <div>
                                <small>
                                    ...
                                    <a href="${pageContext.request.contextPath}/category/${post.category_id}">${post.category.name}</a>
                                </small>
