...
<head>
    ...
    <title>${sessionScope.admin.blog_title} - Link Manage</title>
</head>
<body>
<div id="Top">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${requestScope.links}" var="link">
                            <tr>
                                <td>${link.id}</td>
                                <td>${link.name}</td>
                                <td><a href="${link.url}" target="_blank">${link.url}</a>
                                </td>
                                <td>
                                    <div class="btn-group">
                                        <a href="${pageContext.request.contextPath}/admin/link/edit/${link.id}">
                                            <button type="submit" class="btn btn-info btn-sm p-1">Edit</button>
                                        </a>
                                        <form class="inline" method="post"
                                              action="${pageContext.request.contextPath}/admin/link/delete/${link.id}">
