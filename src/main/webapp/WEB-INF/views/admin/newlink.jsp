...
<head>
    ...
    <title>${sessionScope.admin.blog_title} - NewLink</title>
</head>
<body>
<div id="Top">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-12 p-3 bg-white mt-3">
                    <form action="${pageContext.request.contextPath}/admin/link/new" method="post" class="form"
                          role="form">
                        ...
                        <div class="form-group required"><label class="form-control-label" for="url">URL</label>
                            <input class="form-control" id="url" name="url" required type="text" value="">
                        </div>
