...
<head>
    ...
    <title>${sessionScope.admin.blog_title} - Category Manage</title>
</head>
<body>
<div id="Top">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <c:if test="${category.posts.size() == 0}">
                                            <form class="inline" method="post"
                                                  action="${pageContext.request.contextPath}/admin/category/delete/${category.id}">
