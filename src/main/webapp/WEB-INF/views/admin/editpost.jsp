...
<head>
    ...
    <title>${sessionScope.admin.blog_title} - EditPost</title>
</head>
<body>
<div id="Top">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-12 p-3 bg-white mt-3">
                    <form action="${pageContext.request.contextPath}/admin/post/edit/${requestScope.post.id}"
                        ...
                        <div class="form-group required"><label class="form-control-label"
                            ...
                            <textarea class="form-control" id="subtitle" name="subtitle"
                                      required>${requestScope.post.subtitle}</textarea>
                        </div>
                        <div class="form-group required"><label class="form-control-label"
                        ...
                        <div class="form-group required"><label class="form-control-label" for="body">Body</label>
                            <textarea class="ckeditor form-control" id="body" name="body"
                                      required>${requestScope.post.body}</textarea>
                        </div>
